...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.current_demo'
        db.add_column('app_event', 'current_demo',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='presenting_events', null=True, to=orm['app.Demo']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.current_demo'
        db.delete_column('app_event', 'current_demo_id')
