...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demo.description'
        db.add_column('app_demo', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=144, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demo.description'
        db.delete_column('app_demo', 'description')
